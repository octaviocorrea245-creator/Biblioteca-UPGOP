<x-app-layout>
    <x-slot name="header">Nuevo Libro</x-slot>
                ...
                <form method="POST" action="{{ route('libros.store') }}">
                    ...
                    <div class="g2">
                        ...
                        <div class="f">
                            <label>Tipo</label>
                            <select name="tipo">
                                <option value="Regular" {{ old('tipo','Regular')==='Regular'?'selected':'' }}>Regular</option>
                                <option value="Donado" {{ old('tipo')==='Donado'?'selected':'' }}>Donado</option>
                                <option value="Adquirido" {{ old('tipo')==='Adquirido'?'selected':'' }}>Adquirido</option>
                            </select>
                        </div>
                    </div>
                    <div class="f">
                    ...
                    <div class="ff">
                        <div class="fl">
                            <button type="submit" class="btn bs">Guardar libro</button>
