...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/profile/crear-usuario',   [ProfileController::class, 'crearUsuario'])->name('profile.crearUsuario');

    // Catálogos
    Route::resource('carreras',  CarreraController::class);
    Route::resource('alumnos',   AlumnoController::class);

    // Libros — rutas personalizadas ANTES del resource
    ...
    Route::get( 'libros/plantilla-donaciones',                      [LibroController::class, 'plantillaDonaciones'])->name('libros.plantilla.donaciones');
    ...
    // Donaciones
    Route::resource('donaciones', DonacionController::class)->parameters(['donaciones' => 'donacion']);
    ...
    // Reposiciones — rutas personalizadas ANTES del resource para evitar conflicto con {reposicion}
    Route::post('reposiciones/importar',                            [ReposicionController::class, 'importar'])->name('reposiciones.importar');
    Route::resource('reposiciones', ReposicionController::class)->parameters(['reposiciones' => 'reposicion']);
